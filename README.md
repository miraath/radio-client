...
This app is a small react app that display miraath radio according to list provided by the admin panel.

## To build the project:

- clone the app
- install npm dependencies with `npm install` or `yarn`
- launch development server with `npm run start` or `yarn start`
- build the app with `npm run build` or `yarn build`

## Original doc of the generated App :
